"""
Django's settings for dayz_website project.
...
SECRET_KEY = 'django-insecure-wet#*1k50f1i+s$xrdsw5btu=*^!ie@=f9f$9xda$nbdj%h*ha'
...
WSGI_APPLICATION = 'dayz_website.wsgi.application'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'user.pipeline.associate_existing_user',
